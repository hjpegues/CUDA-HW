...
// nvcc HW7_Hayden.cu -o HW7 -lglut -lGL
...
#define A  -0.74543	//Real part of C
#define B  0.11301	//Imaginary part of C
...
__global__ void colorPixels(float *pixels, float xMin, float yMin, float dx, float dy, int width, int height) 
{
	...
	pixels[id+1] = 0.05; //Setting the green
	pixels[id+2] = 0.7; //Setting the blue 
}
