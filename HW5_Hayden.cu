...
/*
 ...
 Line 74: Added a line to print the memory bus width, which tells you the number of pathways
 the gpu has to move data between processor and memory
 Line 75: Added a line to print the clock rate of the memory on the GPU
*/
