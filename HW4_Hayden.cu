...
/*
 ...
 line 94: changed grid size to 64
 lines 132 & 150: replaced the original a[id] + b[id] with the longer one
 line 141: added stride, which tells each thread how many elements it needs to jump
 lines 147-151: added a for loop inside the if statements and used pragma unroll to "unroll" it
*/
